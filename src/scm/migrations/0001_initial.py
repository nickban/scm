# Generated by Django 3.0.2 on 2020-02-25 12:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bankaccount', models.CharField(blank=True, max_length=100, null=True, verbose_name='银行账户')),
                ('bankaccountnumber', models.CharField(blank=True, max_length=100, null=True, verbose_name='银行账号')),
            ],
        ),
        migrations.CreateModel(
            name='Finance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('shipping_sample', models.CharField(max_length=200, verbose_name='船头板')),
                ('status', models.CharField(choices=[('NORMAL', '正常'), ('WARNING', '警告'), ('URGENT', '紧急')], default='NORMAL', max_length=100, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('bulk_fabric', models.CharField(max_length=200, verbose_name='大货布')),
                ('status', models.CharField(choices=[('NORMAL', '正常'), ('WARNING', '警告'), ('URGENT', '紧急')], default='NORMAL', max_length=100, verbose_name='状态')),
