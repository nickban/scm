# Generated by Django 3.0.2 on 2020-02-16 04:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('NEW', '新建'), ('SENT_FACTORY', '送工厂'), ('COMFIRMED', '已确认'), ('SHIPPED', '已出货')], default='NEW', max_length=50, verbose_name='订单状态')),
