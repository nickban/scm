...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='档口名')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('os_avatar', models.ImageField(blank=True, upload_to='samples/avatar/', verbose_name='款式图')),
                ...
                ('size_spec_factory', models.ImageField(blank=True, upload_to='samples/size_spec_factory/', verbose_name='尺寸表(工厂)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pic', models.ImageField(blank=True, upload_to='swatches/')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='swatches', to=settings.AUTH_USER_MODEL)),
                ('fabric_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='swatches', to='scm.Fabric_Item')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, upload_to='samples/size_specs/')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='size_specs', to='scm.Sample', verbose_name='样板')),
            ],
        ),
        migrations.CreateModel(
            name='Sample_pics',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pic', models.ImageField(blank=True, upload_to='samples/pics/')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pics', to='scm.Sample', verbose_name='样板')),
            ],
        ),
        migrations.CreateModel(
            name='Sample_os_pics',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.ImageField(blank=True, upload_to='samples/os_pics/')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='os_pics', to='scm.Sample', verbose_name='样板')),
            ],
        ),
        migrations.AddField(
            model_name='sample',
        ...
        migrations.AddField(
            model_name='sample',
            name='swatches',
            field=models.ManyToManyField(blank=True, null=True, to='scm.Swatch'),
        ),
        migrations.CreateModel(
            name='PostAttachment',
            fields=[
        ...
        migrations.AddField(
            model_name='fabric_item',
            name='fabric_shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fabricitems', to='scm.Fabric_Shop'),
        ),
        migrations.AddField(
            model_name='sample',
            name='designer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='samples', to='scm.Designer', verbose_name='设计师'),
        ),
        migrations.AddField(
            model_name='sample',
            name='factory',
